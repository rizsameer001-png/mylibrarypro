...
const seed = async () => {
  ...
  await MembershipPlan.insertMany([
    { name: 'Basic', description: 'Basic library access', duration: 30, borrowingLimit: 2, ebookAccess: false, price: 0 },
    { name: 'Standard', description: 'Standard library access', duration: 90, borrowingLimit: 5, ebookAccess: false, price: 9.99 },
    { name: 'Premium', description: 'Full access including e-books', duration: 365, borrowingLimit: 10, ebookAccess: true, price: 29.99 },
  ]);
